...
public class MainWidnow {
	...
	private void initialize() {
		...
		panelLogIn_MainWindow.setBorder(new BevelBorder(BevelBorder.RAISED, new Color(0, 0, 153), new Color(0, 0, 153),
		...
		btn_Login_MainWindow.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if ((UsernameTextField_LogIn_MainWindow.getText().equals("Usario_01"))
						|| (passwordField_LogIn_MainWindow.getText().equals("12345"))) {
		...
		Icon01_MainWindow.setIcon(
				new ImageIcon("C:\\Users\\Diego\\Documents\\GitHub\\TheBaldAlliance\\img\\icons8-usuario-30.png"));

		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setBounds(10, 124, 46, 39);
		panelLogIn_MainWindow.add(lblNewLabel_1);
		lblNewLabel_1.setIcon(
				new ImageIcon("C:\\Users\\Diego\\Documents\\GitHub\\TheBaldAlliance\\img\\icons8-contraseña-30.png"));

		JPanel SignUpPanel_MainWindow = new JPanel();
		SignUpPanel_MainWindow.setBorder(new BevelBorder(BevelBorder.RAISED, new Color(0, 0, 153), new Color(0, 0, 153),
				new Color(0, 0, 0), new Color(0, 0, 0)));
		...
		Image01_MainWindow.setIcon(new ImageIcon(
				"C:\\Users\\Diego\\Documents\\GitHub\\TheBaldAlliance\\img\\output-onlinepngtools (2).png"));
